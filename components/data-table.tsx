    ...
    <Tabs defaultValue="outline" className="w-full flex-col justify-start gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Select defaultValue="outline">
          <SelectTrigger className="flex w-full sm:w-fit lg:hidden" size="sm" id="view-selector">
            <SelectValue placeholder="보기 선택" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="outline">개요</SelectItem>
            <SelectItem value="past-performance">과거 실적</SelectItem>
            <SelectItem value="key-personnel">핵심 인력</SelectItem>
            <SelectItem value="focus-documents">주요 문서</SelectItem>
          </SelectContent>
        </Select>
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 lg:flex">
          ...
          <TabsTrigger value="key-personnel">
            핵심 인력 <Badge variant="secondary">2</Badge>
          </TabsTrigger>
          <TabsTrigger value="focus-documents">주요 문서</TabsTrigger>
        </TabsList>
        <div className="flex items-center gap-2">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="sm">
                <IconLayoutColumns />
                <span className="hidden lg:inline">열 사용자 지정</span>
          ...
          <Button variant="outline" size="sm" className="shrink-0">
            <IconPlus />
            <span className="hidden md:inline">섹션 추가</span>
          </Button>
        </div>
      </div>
      <TabsContent value="outline" className="relative flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="text-muted-foreground hidden flex-1 text-sm md:flex">
            {table.getFilteredSelectedRowModel().rows.length}개 / {table.getFilteredRowModel().rows.length}개 행 선택됨
          </div>
          <div className="flex w-full items-center gap-4 sm:w-fit sm:gap-8">
    ...
    <Drawer direction={isMobile ? "bottom" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          ...
          <DrawerDescription>최근 6개월 총 방문자 수 표시</DrawerDescription>
        </DrawerHeader>
            ...
            <>
              ...
              <div className="grid gap-2">
                <div className="flex gap-2 leading-none font-medium">
                  이번 달 5.2% 상승 추세 <IconTrendingUp className="size-4" />
                </div>
                <div className="text-muted-foreground">
                  최근 6개월 총 방문자 수를 표시합니다. 이것은 레이아웃을 테스트하기 위한 임의의 텍스트입니다. 여러 줄에
                  걸쳐 있으며 줄바꿈되어야 합니다.
                </div>
              </div>
              <Separator />
